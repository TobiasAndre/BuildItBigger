 ...
 * on 2017-05-04 at 22:47:28 UTC 
 * Modify at your own risk.
 */

package com.tobiasandre.builditbigger.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param content the {@link com.tobiasandre.builditbigger.backend.myApi.model.JokeBean}
   * @return the request
   */
  public PutJoke putJoke(com.tobiasandre.builditbigger.backend.myApi.model.JokeBean content) throws java.io.IOException {
    PutJoke result = new PutJoke(content);
    initialize(result);
    return result;
  }

  public class PutJoke extends MyApiRequest<com.tobiasandre.builditbigger.backend.myApi.model.JokeBean> {
     ...
     * @since 1.13
     */
    protected PutJoke(com.tobiasandre.builditbigger.backend.myApi.model.JokeBean content) {
      super(MyApi.this, "POST", REST_PATH, content, com.tobiasandre.builditbigger.backend.myApi.model.JokeBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.tobiasandre.builditbigger.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.tobiasandre.builditbigger.backend.myApi.model.MyBean.class);
